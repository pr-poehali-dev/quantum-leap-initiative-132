  ...
  return (
    <section id="contact" className="py-32 px-6 bg-card">
      <div className="max-w-2xl mx-auto text-center">
        <span className="text-sm uppercase tracking-widest text-muted-foreground mb-4 block">Контакт</span>
        ...
        <p className="text-muted-foreground text-lg mb-10 leading-relaxed">
          Напишите нам — мы открыты к сотрудничеству, замечаниям и идеям для развития проекта.
        </p>
        ...
        {submitted ? (
          <div className="p-8 rounded-2xl bg-sage/10 border border-sage/20">
            ...
            <p className="text-muted-foreground">Мы ответим вам в ближайшее время.</p>
          </div>
        ) : (
